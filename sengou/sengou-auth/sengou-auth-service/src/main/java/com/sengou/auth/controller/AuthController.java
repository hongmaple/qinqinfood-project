package com.sengou.auth.controller;

import com.sengou.auth.config.JwtProperties;
import com.sengou.auth.entity.UserInfo;
import com.sengou.auth.service.AuthService;
...
public class AuthController {
     ...
     */
    @GetMapping("verify")
    public ResponseEntity<UserInfo> verifyUser(@CookieValue("SG_TOKEN")String token){
        try {
            // 从token中解析token信息
